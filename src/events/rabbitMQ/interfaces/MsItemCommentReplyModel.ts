export interface MsItemCommentReplyModel {
  actor: MsItemCommentReplyModelActor;
  anonymous?: boolean;
  categorisation?: Categorisation;
  commentReplyUpsertedId?: string;
  comments: Comment[];
  commentUpsertedId?: string;
  countInGroup?: number;
  createdAt: Date;
  deletedAt?: Date;
  editable: Editable;
  ...
  likes: MsItemCommentReplyModelLike[];
  moderation?: MsItemCommentReplyModelModeration;
...
export interface MsItemCommentReplyModelActor {
  firstName: string;
  lastName: string;
  username: string;
}
...
export interface MsItemCommentReplyModelLike {
...
export interface MsItemCommentReplyModelModeration {
  banned: boolean;
  labels: string[];
  waiting: boolean;
}
