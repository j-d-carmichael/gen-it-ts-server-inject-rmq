export interface MsItemModel {
  ...
  likes: MsItemModelLike[];
  moderation?: MsItemModelModeration;
...
export interface MsItemModelActor {
  firstName: string;
  lastName: string;
  username: string;
}
...
export interface MsItemModelLike {
...
export interface MsItemModelModeration {
  banned: boolean;
  labels: string[];
  waiting: boolean;
}
