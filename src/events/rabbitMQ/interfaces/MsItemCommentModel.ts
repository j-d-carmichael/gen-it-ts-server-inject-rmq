export interface MsItemCommentModel {
  actor: MsItemCommentModelActor;
  anonymous?: boolean;
  ...
  likes: MsItemCommentModelLike[];
  moderation?: MsItemCommentModelModeration;
...
export interface MsItemCommentModelActor {
  firstName: string;
  lastName: string;
  username: string;
}
...
export interface MsItemCommentModelLike {
...
export interface MsItemCommentModelModeration {
  banned: boolean;
  labels: string[];
  waiting: boolean;
}
