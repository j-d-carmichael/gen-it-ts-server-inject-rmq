export interface MsItemManagedByNotItemOwner {
  item: Item;
  managedBy: ManagedBy;
}
...
export interface ManagedBy {
  actor: ManagedByActor;
  /**
   * Enum value corresponding to the user's permission state to manage, i.e. edit or delete.
   * Includes 'forbidden' to indicate user is not allowed to manage.
   */
  managerType: ManagerType;
}

export interface ManagedByActor {
  firstName: string;
  lastName: string;
  username: string;
}
