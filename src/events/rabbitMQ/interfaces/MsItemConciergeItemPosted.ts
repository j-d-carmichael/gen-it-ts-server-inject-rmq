export interface MsItemConciergeItemPosted {
  channel: MsItemConciergeItemPostedChannel;
  item: Item;
}

export interface MsItemConciergeItemPostedChannel {
  /**
...
export interface Item {
  ...
  performanceValues: ItemPerformanceValues;
  pins: Pin[];
  reminder?: Reminder;
  /**
...
export interface ItemPerformanceValues {
